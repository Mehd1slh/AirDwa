...
class AutomatedMapBuilder:
    ...
    def fetch_osm_data(self):
        ...
        # 1. Hospitals and Pharmacies -> Health Facilities
        try:
            ...
            for idx, row in health_pois.iterrows():
                ...
                self.data["health_facilities"].append([x, y])
        except Exception:
            print("No health facilities found in this area.")

        # 2. Douars (Villages & Hamlets) -> Add Station IDs
        try:
